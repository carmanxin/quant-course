...
// Inline the production flow to see what augmented text looks like
...
// Inline buildScaffold (need to track locallyDefined)
...
const { used, locallyDefined } = buildScaffold(codeBody)
